...
const SigninTeacher = ({onRouteChange}) =>{
    return(
        ...
        <main className="pa4 black-80">
            <form className="measure centre ">
                ...
                <div className="">
                <input onClick={ () => onRouteChange('hometeach')} className="b ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib" type="submit" value="Sign in"/>
                </div>
