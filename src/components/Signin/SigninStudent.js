...
const SigninStudent = ({onRouteChange}) =>{
    return(
        ...
        <main className="pa4 black-80">
            <form className="measure centre ">
                ...
                <div className="">
                <input className="b ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib" type="submit" onClick={ () => onRouteChange('homestud')} value="Sign in"/>
                </div>
